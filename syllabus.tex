...
\begin{itemize}
    ...
    \item This class meets for one 50-minute class period each week over the Spring semester and carries the expectation that students will work on course learning activities (reading, writing, problem sets, studying, etc) for about 2 hours out of the classroom for every class period. The syllabus includes more information about meeting times and expectations for student work
...
Please note that although attendance and participation are not graded, they are essential to this discussion-based course. Regular attendance and active participation are expected.
